...
<footer id="footer" class="footer footer-layout1 text-center bg-dark">
    <div class="footer-inner">
        ...
        <div class="footer-bottom">
            ...
            <svg class="footer__divider-shape-bottom" xmlns="https://www.w3.org/2000/svg" width="142" height="17" viewbox="0 0 142 17">
                <path d="M800,600V583c8.782,15.985,46.811,11.315,56,12a35.721,35.721,0,0,1,15,5m-71,0V583c-8.782,15.985-46.811,11.315-56,12a35.717,35.717,0,0,0-15,5" transform="translate(-729 -583)"></path>
            </svg>
        </div><!-- /.Footer-bottom -->
    </div><!-- /.Footer-inner -->
</footer><!-- /.Footer -->
...
<div class="search-popup">
    ...
    <form class="module__search-form" method="get" action="/search">
        <input type="text" min="1" required name="query" class="search__input" placeholder="Type Book,PDF Name  Then Enter">
