...
<section id="blogGrid" class="blog blog-grid pb-60 bg-overlay-2">
    <div class="container">
        ...
        <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                    <div class="heading text-center mb-50">
                        <span class="heading__subtitle">Result of</span>
                        <h2 class="heading__title">{{$search_title}}</h2>
        ...
        <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post__content">
                            <h4 class="post__title"><a href="/c/{{$book->id}}" title="{{$book->title}}">{{$book->title}}</a></h4>
                            <p class="post__desc">{{$book->description}}</p>
                            <a href="/c/{{$book->id}}" class="btn btn__secondary btn__link">View Book</a>
                        </div><!-- /.post__content -->
                    </div><!-- /.post-item -->
                </div><!-- /.col-lg-4 -->
            ...
            @endforeach
<script>
    document.title = 'Result Search For: {{$search_title}}';
</script>
